...
typedef enum {
    BARCHART_THEME_FRAME_INDEX      = 0,
    BARCHART_THEME_AXIS_INDEX       = 1,
    BARCHART_THEME_BAR_INDEX        = 2,
    BARCHART_THEME_BAR_CH1_INDEX    = 3,
    BARCHART_THEME_BAR_CH2_INDEX    = 4,
    BARCHART_THEME_BAR_CH3_INDEX    = 5,
    BARCHART_THEME_BACKGROUND_INDEX = 6,
    BARCHART_THEME_LABEL_INDEX      = 7,
